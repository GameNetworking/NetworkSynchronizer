...
void decode_variable(bool &val, DataBuffer &p_buffer, const NetworkInterface &p_interface) {
...
void decode_variable(float &val, DataBuffer &p_buffer, const NetworkInterface &p_interface) {
